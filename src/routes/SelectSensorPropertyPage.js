...
import {SelectSensorPropertyComponent} from "../components/SelectSensorPropertyComponent";

const { Header, Content, Footer } = Layout;
export default class SelectSensorPropertyPage extends React.Component {
  state={
    username:null,
  }
  componentDidMount() {
